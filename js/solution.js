...
function checkMenuWidth() {
    ...
    const menuDefaultWitdh = drag.getBoundingClientRect().width + comments.getBoundingClientRect().width+draw.getBoundingClientRect().width + share.getBoundingClientRect().width + newPic.getBoundingClientRect().width + parseFloat(getComputedStyle(shareTools).borderWidth || getComputedStyle(shareTools).borderLeftWidth) * 2;
